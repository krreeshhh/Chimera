...
const SpecularButton = ({
  ...
  const sizeClass = size === 'sm' ? 'specular-btn-sm' : size === 'lg' ? 'specular-btn-lg' : 'specular-btn-md';
  ...
  return (
    <button
      ...
      disabled={disabled}
      onClick={onClick}
      className={`specular-btn ${sizeClass}${className ? ` ${className}` : ''}`}
      style={
        {
          '--sb-radius': `${radius}px`,
          '--sb-tint': tint,
    ...
    >
      <span ref={fxRef} aria-hidden="true" className="specular-btn-fx" />
